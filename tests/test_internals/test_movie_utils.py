...
class TestVideoContext(unittest.TestCase):
    ...
    def run_conversion_with_context(self, context):
    ...
    def test_normal_context_hdf5io_simple(self):
    ...
    def test_cv2_hdf5io_simple(self):
    ...
    def test_simple_context_hdf5io_simple(self):
    ...
    def test_normal_context_hdf5io_converter(self):
        self.run_conversion_with_context("normal")

    def test_cv2_hdf5io_converter(self):
        self.run_conversion_with_context("cv2")

    def test_simple_context_hdf5io_converter(self):
        self.run_conversion_with_context("simple")

    def test_hard_code_fps_hdf5io_converter(self):
        self.run_conversion_with_context("")
